...
CLI:   python -m ai_image_id.main path/to/image.jpg
API:   uvicorn ai_image_id.main:api --reload   then POST /analyze with multipart 'file'
"""
...
def analyze_image(path: str | Path, detector_ckpt: str | Path | None = None) -> AnalysisResult:
    from .detector import analyze_detector  # lazy: torch optional
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        print("usage: python -m ai_image_id.main <image_path>")
        raise SystemExit(1)
